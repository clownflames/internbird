...
import { authClient } from "@/lib/auth-client";  // 👈 sirf ye
...
function GoogleIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" {...props}>
      ...
      <path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.2 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1A11 11 0 0 0 2.18 7.07l3.66 2.84C6.71 7.31 9.14 5.38 12 5.38Z" />
    </svg>
  );
}
...
function LoginForm() {
  ...
  const handleOAuth = async (provider: "google" | "github") => {
    ...
    try {
      ...
      // better-auth khud redirect karega — yahan aage kuch nahi chalega
    } catch (err) {
      console.error(err);
